...
<form action="process.php?action=addAchiev" method="post"  name="frmListUser" id="frmListUser">
  <table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#336699" class="entryTable">
    <tr id="entryTableHeader">
      <td><center>:: Other_Achievement ::</center></td>
    </tr>
    <tr>
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <tr class="entryTable">
              <td class="label">&nbsp;Other_Achievement</td>
              <td class="content"><textarea name="OtherAchievement" class="box" id="OtherAchievement"  /></textarea></td>
            </tr>
