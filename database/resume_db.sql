...
CREATE TABLE IF NOT EXISTS `tbl_educational` (
  ...
  `cid` int(10) NOT NULL,
  `School/College Name` varchar(40) NOT NULL,
  `Degree` varchar(40) NOT NULL,
  `Subject` varchar(200) NOT NULL,
  `Years` int(10) NOT NULL,
  `Board/ University` varchar(40) NOT NULL,
...
INSERT INTO `tbl_personal` (`rid`, `cid`, `School/College Name`, `Degree`, `Subject`, `Years`, `Board/ University`, `Obtained Marks`, `Total Marks`) VALUES
(1, 8, 'SKIT,Jaipur', 'Btech', 'Computer Science', '4', 'RTU', 90, 100);
...
INSERT INTO `tbl_personal` (`cid`, `pname`, `pfname`, `pgender`, `pnation`, `plang`, `phobby`, `pdoh`) VALUES
(1, rahul, 'efmr', 'Male', 'india', 'hindi,english', 'playing cricket', 12/24/94, 100);
